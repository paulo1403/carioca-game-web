/*
  ...
  - You are about to drop the column `totalBuys` on the `GameSession` table. All the data in the column will be lost.
...
INSERT INTO "new_GameSession" ("createdAt", "currentRound", "currentTurn", "deck", "direction", "discardPile", "id", "lastAction", "pendingBuyIntents", "pendingDiscardIntents", "status", "updatedAt") SELECT "createdAt", "currentRound", "currentTurn", "deck", "direction", "discardPile", "id", "lastAction", "pendingBuyIntents", "pendingDiscardIntents", "status", "updatedAt" FROM "GameSession";
...
INSERT INTO "new_Player" ("boughtCards", "difficulty", "gameSessionId", "hand", "id", "isBot", "melds", "name", "score") SELECT "boughtCards", "difficulty", "gameSessionId", "hand", "id", "isBot", "melds", "name", "score" FROM "Player";
DROP TABLE "Player";
