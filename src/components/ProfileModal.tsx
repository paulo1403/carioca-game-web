...
import { Key, Loader2, Lock, Save, Trophy, User, X } from "lucide-react";
            ...
            {loadingStats ? (
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-slate-950/50 border border-slate-800 rounded-xl p-4 text-center">
                  <div className="text-2xl font-bold text-blue-400">{stats.stats.gamesPlayed}</div>
                  <div className="text-[10px] text-slate-500 uppercase tracking-wider mt-1">
                    Partidas
                  </div>
                </div>
                <div className="bg-slate-950/50 border border-slate-800 rounded-xl p-4 text-center">
                  <div className="text-2xl font-bold text-green-400">{stats.stats.gamesWon}</div>
                  <div className="text-[10px] text-slate-500 uppercase tracking-wider mt-1">
                    Ganadas
                  </div>
                </div>
                <div className="bg-slate-950/50 border border-slate-800 rounded-xl p-4 text-center">
                  <div className="text-2xl font-bold text-yellow-400">{stats.stats.winRate}%</div>
                  <div className="text-[10px] text-slate-500 uppercase tracking-wider mt-1">
                    Win Rate
                  </div>
                </div>
                <div className="bg-slate-950/50 border border-slate-800 rounded-xl p-4 text-center">
                  <div className="text-2xl font-bold text-purple-400">{stats.stats.elo}</div>
                  <div className="text-[10px] text-slate-500 uppercase tracking-wider mt-1">
                    ELO
                  </div>
                </div>
