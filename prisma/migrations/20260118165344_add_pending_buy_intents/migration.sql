...
INSERT INTO "new_GameSession" ("createdAt", "currentRound", "currentTurn", "deck", "direction", "discardPile", "id", "lastAction", "pendingDiscardIntents", "status", "totalBuys", "updatedAt") SELECT "createdAt", "currentRound", "currentTurn", "deck", "direction", "discardPile", "id", "lastAction", "pendingDiscardIntents", "status", "totalBuys", "updatedAt" FROM "GameSession";
