  ...
  const updates = [
    {
      ...
      description:
        "Se corrigió el conteo de compras, las reglas de cartas extra según turno y la penalización por compras restantes en el resumen final.",
      type: "fix",
    },
    {
    ...
    },
    {
      ...
      description:
        "Escalas requieren carta exacta y grupos exigen 2 naturales en mano para poder robar joker.",
      type: "fix",
    },
    {
      title: "Orden de mano sin drag & drop",
      description:
        "Nuevo orden manual con botones, persistente por jugador, y auto/valor/palo en desktop y mobile.",
      type: "feature",
    },
    {
      title: "¡COMPRO! + prioridad de compra",
      description:
        "Aviso en tiempo real, badge en jugadores, sonido y cooldown para coordinar compras.",
      type: "feature",
    },
    {
    ...
    },
    {
      ...
      description:
        "Rediseño del tablero con panel fijo inferior, mejor legibilidad y accesos rápidos.",
      type: "improvement",
    },
    {
      title: "Agregar a juegos más claro",
      description:
        "Al seleccionar carta azul puedes elegir entre descartar o agregar a un juego desde un panel dedicado.",
      type: "improvement",
    },
    {
      title: "Resultados por ronda",
      description:
        "Al finalizar la ronda se muestran puntos de esa ronda; el total solo en la última ronda.",
      type: "feature",
    },
  ];
        ...
        <div className="p-6 overflow-y-auto custom-scrollbar space-y-6">
          <div className="bg-blue-500/5 border border-blue-500/10 rounded-2xl p-4 flex gap-3">
            ...
            <p className="text-sm text-slate-300 leading-relaxed">
              Hemos realizado varias mejoras para hacer que Carioca Online sea más emocionante y
              justo para todos los jugadores.
            </p>
          </div>
                ...
                <div className="flex items-start gap-4">
                  <div
                    className={`mt-1 w-2 h-2 rounded-full shrink-0 ${
                      update.type === "feature" ? "bg-cyan-400" : "bg-indigo-400"
